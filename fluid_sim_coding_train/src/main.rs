...
fn model(app: &App) -> Model {
    ...
    let pipeline = Arc::new(
        vk::GraphicsPipeline::start()
            ...
            .triangle_strip()  // This makes 2 triagles with 4 points.
...
fn mouse_pressed(_app: &App, _m: &mut Model, _button: MouseButton) {
}
...
void main() {
    ...
    // Vulkan viewport has y axis flipped with respect to nannou
...
void main() {
    ...
    // f_color = vec4(tex_coords.y, 0.0, 0.0, 1.0);
